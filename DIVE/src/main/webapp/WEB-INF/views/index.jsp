	...
	<nav class="content_menu">
		<ul class="menu_list">
			<li><a href="/product/list"><img
					src="/resources/images/bookmark.png" alt="" width="60px"
					height="60px">
				<p>상품 목록</p></a></li>
			<li><a href="/board/list"><img
					src="/resources/images/calendar.png" alt="" width="60px"
					height="60px">
				<p>자유게시판</p></a></li>
			<li><a href="/"><img src="/resources/images/smartphone.png"
					alt="" width="60px" height="60px">
				<p>미니 게임</p></a></li>
			<li><a href="/"><img src="/resources/images/icon.png" alt=""
